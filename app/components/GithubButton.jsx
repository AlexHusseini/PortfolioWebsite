...
export default function GithubButton() {
  return (
    <motion.a
      ...
      className="fixed bottom-6 left-6 px-4 py-2 rounded-lg 
                 bg-gray-200/90 dark:bg-gray-800/90 
                 backdrop-blur-sm shadow-lg
                 border border-gray-300/30 dark:border-gray-700/30
                 text-sm font-medium text-gray-800 dark:text-gray-200
                 hover:bg-gray-300/90 dark:hover:bg-gray-700/90
    ...
    >
      ...
      <span className="hidden sm:inline">Website Source Code</span>
